 ...
 */
final class Version20200527134824 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, parent_id INT DEFAULT NULL, description TEXT NOT NULL, vote INT DEFAULT NULL, PRIMARY KEY(id))');
